...
public class PopularMoviesDataSourceFactory implements DataSource.Factory<Integer, Movie> {
    private final MutableLiveData<PageKeyedMovieDataSource> sourceLiveData;
    private final MovieService networkService;

    public PopularMoviesDataSourceFactory(@NonNull MovieService networkService) {
    ...
    public static class PageKeyedMovieDataSource extends PageKeyedDataSource<Integer, Movie> {
        ...
        public void loadInitial(@NonNull LoadInitialParams<Integer> params, @NonNull LoadInitialCallback<Integer, Movie> callback) {
            Call<ResponseMovie> call = networkService.getPopularMovies(1);
        ...
        public void loadAfter(@NonNull final LoadParams<Integer> params, @NonNull final LoadCallback<Integer, Movie> callback) {
            networkState.postValue(NetworkState.LOADING);
            networkService.getPopularMovies(params.key).enqueue(
